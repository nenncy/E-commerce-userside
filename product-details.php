							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="cart.php"><span class="htc__qua">0</span>Cart</a></li> 
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							...
							<?php echo "<img src='../media/product".$result['image']."' >" ?>
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information">
								...
								<span>
									<span>PRIZE : <?php echo $result['saving_price']," ","Rs"?></span><br>
									<label>Quantity:<?php echo $result['qty']?></label><br>
								</span>
